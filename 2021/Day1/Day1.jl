...
# ╔═╡ 7e9211ba-5468-11ec-0f84-fd23ee0f8d52
html"<article class=\"day-desc\"><h2>--- Day 1: Sonar Sweep ---</h2><p>You're minding your own business on a ship at sea when the overboard alarm goes off! You rush to see if you can help. Apparently, one of the Elves tripped and accidentally sent the sleigh keys flying into the ocean!</p>
...
# ╔═╡ cf71f6fb-ddd9-48cf-a0ae-e9e047b489a2
input = [parse(Int64, depth_str) for depth_str in readlines("input.txt")];

# ╔═╡ 7c59ceac-8656-4dce-87bb-1ba6eacbe85f
begin
	local count = 0;
	local prev_depth = input[1];
...
# ╔═╡ 4cc6e8bb-e0ba-4235-a855-c0b0b4991236
html"<article class=\"day-desc\"><h2 id=\"part2\">--- Part Two ---</h2><p>Considering every single measurement isn't as useful as you expected: there's just too much noise in the data.</p>
...
# ╔═╡ 3451f75d-7f58-460f-9841-572fb89922f7
begin
